                ...
                <div class="col-lg-2">
                    <div class="element-footer">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('site.internships.index') }}">{{ __('models.internships') }} </a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="element-footer">
                        ...
                        <ul>
                            <li><a> <i class="bi bi-geo-alt"></i> {{ getSetting('address') ?? 'Default Address' }} </a></li>
                            <li><a href="tel:{{ getSetting('phone_1') ?? '#' }}"> <i class="bi bi-telephone"></i> {{ getSetting('phone_1') ?? 'Default Phone 1' }} </a></li>
                            <li><a href="tel:{{ getSetting('phone_2') ?? '#' }}"> <i class="bi bi-telephone"></i> {{ getSetting('phone_2') ?? 'Default Phone 2' }} </a></li>
                            <li><a href="https://wa.me/{{ getSetting('whatsapp') ?? '#' }}"> <i class="bi bi-whatsapp"></i> {{ getSetting('whatsapp') ?? 'Default WhatsApp' }} </a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        <div class="logo-footer">
                            <a href="{{ route('site.home') }}">
                                @isset($footerLogo = getSetting('footer_logo'))
                                    <img src="{{ asset('storage/' . $footerLogo) }}" alt="">
                                @else
                                    <img src="{{ asset('storage/default-logo.png') }}" alt="">
                                @endisset
                            </a>
                        </div>
                    </div>
