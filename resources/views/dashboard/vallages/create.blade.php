                ...
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('admin.vallages.index') }}">{{ __('models.values') }}</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form form-vertical" id="createVallageForm" action="{{ route('admin.vallages.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
